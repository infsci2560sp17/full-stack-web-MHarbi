...
public class FileUploadController {
    ...
    public String handleFileUpload(@RequestParam("files") MultipartFile[] files,
        ...
        String storeMsg = storageService.store(files, "1");
        if(storeMsg == "")
            storeMsg = "You successfully uploaded files!";
        else {
            // delete the stored recipe;
        }
        redirectAttributes.addFlashAttribute("message", storeMsg);
